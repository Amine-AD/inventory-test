...
import type { Route } from "./+types/dashboard-v2";
...
export default function DashboardV2({ loaderData }: Route.ComponentProps) {
  return (
    <Page title="Inventory Dashboard V2">
      <Layout>
        <Layout.Section>
          <Card>
            <BlockStack gap="400">
      ...
      <IndexTable.Cell>
        <InlineStack align="end">
          <Text
            as="span"
            variant="bodyMd"
            tone={isOutOfStock ? "critical" : "success"}
          >
            {displayStock}
          </Text>
        </InlineStack>
      ...
      <IndexTable.Cell>
        <InlineStack align="end">
          ...
          >
            ...
            >
              {isOutOfStock ? "Out of Stock" : "Claim One"}
            </Button>
          </fetcher.Form>
        </InlineStack>
      </IndexTable.Cell>
